<script type="text/javascript">
	...
	$(document).ready(function() {
		...
		$("#printPdf").on("click", function(e) {
			...
			//alert(prcode);
			window.open("<?php echo site_url('securityreport/reportPdf/'); ?>" + date_from + "/" + date_to , '_blank', 'height=900,width=600,toolbar=no,directories=no,status=no, menubar=no,scrollbars=no,resizable=no ,modal=yes');
		});
		...
		$("#printExl").on("click", function(e) {
			...
			window.open("<?php echo site_url('securityreport/reportExcel/'); ?>" + date_from + "/" + date_to, '_blank');
		});
