                ...
                <form id="fsearch" class="form-horizontal" role="form">
                    ...
                    <fieldset>
                        ...
                        <div class="rows">
                            ...
                            <div class="col-sm-2">
                                <input type="text" name="crno" id="crno" class="form-control tanggal">
                            </div>
                ...
                <div class="widget widget-table">
                    ...
                    <div class="widget-content">
                        ...
                        <div class="form-group row">
                            <label for="cncode" class="col-sm-1 control-label text-left">Container No </label>
                            <div class="col-sm-2">
                                <input type="text" readonly name="crno" class="form-control" id="crno" value="<?= @$crno ?>">
                            </div>
