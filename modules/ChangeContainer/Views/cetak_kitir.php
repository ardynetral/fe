	...
	<div class="main-content">
		...
		<div class="widget widget-table" id="OrderPra">
			<div class="widget-header">
				<h3><i class="fa fa-table"></i>List Container</h3>
			</div>
			...
			<div class="widget-content">
						...
						<?php else: ?>
							...
							?>
								<tr>
									<td>
										<?php if($gateDate==""):?>
										<a class="btn btn-xs btn-success cchange" href="#" id=""
										data-crid="<?=$row['pracrnoid']?>"
										data-praid="<?=$row['praid']; ?>"  
										data-crno="<?=$row['crno']; ?>" 
										data-cpiorderno="<?=$data['cpiorderno']?>">Change Container</a>
										<?php endif; ?>
									</td>
									<td><?=$i;?>
				...
				<table class="tbl-form" width="100%" style="display:none;">
					<tbody>
						<?php
...
<?= $this->include('\Modules\ChangeContainer\Views\form_change_container');?>
...
<?= $this->Section('script_js');?>
	...
	<?= $this->include('\Modules\ChangeContainer\Views\js'); ?>	
