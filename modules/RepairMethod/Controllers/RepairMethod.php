<?php
namespace Modules\RepairMethod\Controllers;

class RepairMethod extends \CodeIgniter\Controller
{
	private $client;
	...
	public function index()
	{
		...
		$data['data'] = "";
		$data['page_title'] = "Repair Method";
		$data['page_subtitle'] = "Repair Method Page";
		return view('Modules\RepairMethod\Views\index',$data);
	}
}