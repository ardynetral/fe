<?php
namespace Modules\IncomeStatement\Controllers;

class IncomeStatement extends \CodeIgniter\Controller
{
	private $client;
	...
	public function index()
	{
		...
		$data['page_subtitle'] = "Income Statement Page";
		return view('Modules\IncomeStatement\Views\index',$data);
	}
}