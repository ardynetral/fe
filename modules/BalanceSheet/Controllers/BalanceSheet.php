<?php
namespace Modules\BalanceSheet\Controllers;

class BalanceSheet extends \CodeIgniter\Controller
{
	private $client;
	...
	public function index()
	{
		...
		$data['page_subtitle'] = "Balance Sheet Page";
		return view('Modules\BalanceSheet\Views\index',$data);
	}
}