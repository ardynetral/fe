<?php
namespace Modules\JurnalReport\Controllers;

class JurnalReport extends \CodeIgniter\Controller
{
	private $client;
	...
	public function index()
	{
		...
		$data['page_title'] = "Jurnal Report";
		$data['page_subtitle'] = "Jurnal Report Page";
		return view('Modules\JurnalReport\Views\index',$data);
	}
}