<?php
namespace Modules\CashSettlement\Controllers;

class CashSettlement extends \CodeIgniter\Controller
{
	private $client;
	...
	public function index()
	{
		...
		$data['page_title'] = "Cash Settlement";
		$data['page_subtitle'] = "Cash Settlement Page";
		return view('Modules\CashSettlement\Views\index',$data);
	}
}