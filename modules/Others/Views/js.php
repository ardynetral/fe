...
$(document).ready(function() {
	...
	$("#saveData").click(function(e){
		...
		$.ajax({
			url: "<?php echo site_url('others/add'); ?>",
			type: "POST",
			data: formData,
			dataType: 'json',
			success: function(json) {
				if(json.message == "success") {
					...
					window.location.href = "<?php echo site_url('others'); ?>";
				} else {
					Swal.fire({
					  icon: 'error',
					  title: "Error",
	...
	$("#updateData").click(function(e){
		...
		console.log(formData);
		$.ajax({
			url: "<?php echo site_url('others/edit/'); ?>"+$("#cucode").val(),
			type: "POST",
			data: formData,
			dataType: 'json',
			success: function(json) {
	...
	function delete_data(code) {
		$.ajax({
			url: "<?php echo site_url('others/delete/'); ?>"+code,
			type: "POST",
			dataType: 'json',
			success: function(json) {
				if(json.message == "success") {
