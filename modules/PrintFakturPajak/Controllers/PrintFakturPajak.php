<?php
namespace Modules\PrintFakturPajak\Controllers;

class PrintFakturPajak extends \CodeIgniter\Controller
{
	private $client;
	...
	public function index()
	{
		...
		$data['page_title'] = "Print Faktur Pajak";
		$data['page_subtitle'] = "Print Faktur Pajak Page";
		return view('Modules\PrintFakturPajak\Views\index',$data);
	}
}