				...
				<form id="#formCType" class="form-horizontal" role="form">
					...
					<fieldset>
						...
						<div class="form-group">
							...
							<div class="col-sm-3">
								<input type="text" name="prname" class="form-control" id="prname">
							</div>
						</div>
						<div class="form-group">
							<label for="praddr" class="col-sm-2 control-label text-right">Address</label>
							<div class="col-sm-8">
								<input type="text" name="praddr" class="form-control" id="praddr">
							</div>
						</div>					
						<div class="form-group">
						...
						<div class="form-group">
							...
							<div class="col-sm-3">
								<input type="text" name="prremark" class="form-control" id="prremark">
							</div>
						</div>							
						<div class="form-group">
