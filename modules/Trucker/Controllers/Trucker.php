<?php
namespace Modules\Trucker\Controllers;

class Trucker extends \CodeIgniter\Controller
{
	private $client;
	...
	public function index()
	{
		...
		$data['page_title'] = "Trucker";
		$data['page_subtitle'] = "Trucker Page";
		return view('Modules\Trucker\Views\index',$data);
	}
	...
	public function view($code)
	{
		...
		return view('Modules\Trucker\Views\view',$data);
	}	
	...
	public function add()
	{
		...
		$data['page_title'] = "Trucker";
		$data['page_subtitle'] = "Add Trucker Page";				
		$data['country_dropdown'] = country_dropdown($selected='');
		return view('Modules\Trucker\Views\add',$data);		
	}	
	...
	public function edit($code)
	{
		...
		return view('Modules\Trucker\Views\edit',$data);		
	}	
