<?php
namespace Modules\CfsBill\Controllers;

class CfsBill extends \CodeIgniter\Controller
{
	private $client;
	...
	public function index()
	{
		...
		$data['page_title'] = "CFS Bill";
		$data['page_subtitle'] = "CFS Bill Page";
		return view('Modules\CfsBill\Views\index',$data);
	}
}