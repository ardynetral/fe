<?php
namespace Modules\Others\Controllers;

class Others extends \CodeIgniter\Controller
{
	private $client;
	...
	public function index()
	{
		...
		$data['page_subtitle'] = "Others Page";
		return view('Modules\Others\Views\index',$data);
	}
	...
	public function list_data() {
		...
		foreach ($result['data']['datas'] as $k=>$v) {
			...
			$btn_list .='<a href="'.site_url('others/view/').$v["cucode"].'" id="" class="btn btn-xs btn-primary btn-table" data-praid="">view</a>&nbsp;';						
			$btn_list .='<a href="'.site_url('others/edit/').$v["cucode"].'" class="btn btn-xs btn-success btn-table">edit</a>&nbsp;';
	...
	public function view($code)
	{
		...
		return view('Modules\Others\Views\view',$data);
	}	
	...
	public function add()
	{
		...
		$data['page_title'] = "Others";
		$data['page_subtitle'] = "Add Others Page";				
		$data['country_dropdown'] = country_dropdown($selected='');
		return view('Modules\Others\Views\add',$data);		
	}	
	...
	public function edit($code)
	{
		...
		return view('Modules\Others\Views\edit',$data);		
	}	
