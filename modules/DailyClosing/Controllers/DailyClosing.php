<?php
namespace Modules\DailyClosing\Controllers;

class DailyClosing extends \CodeIgniter\Controller
{
	private $client;
	...
	public function index()
	{
		...
		$data['page_title'] = "Daily Closing";
		$data['page_subtitle'] = "Daily Closing Page";
		return view('Modules\DailyClosing\Views\index',$data);
	}
}