...
class Warehouse extends \CodeIgniter\Controller
{
	private $client;
	...
	public function index()
	{
		...
		$data['data'] = "";
		$data['page_title'] = "Register ID CFS Principal";
		$data['page_subtitle'] = "Warehouse Page";
		return view('Modules\Warehouse\Views\index',$data);
	}
}