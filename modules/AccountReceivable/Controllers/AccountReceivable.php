<?php
namespace Modules\AccountReceivable\Controllers;

class AccountReceivable extends \CodeIgniter\Controller
{
	private $client;
	...
	public function index()
	{
		...
		$data['page_title'] = "Account Receivable";
		$data['page_subtitle'] = "Account Receivable Page";
		return view('Modules\AccountReceivable\Views\index',$data);
	}
}