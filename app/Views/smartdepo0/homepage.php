	...
	<section id="home" class="hero-unit">
		<div class="container">
			<div class="hero-content">
				...
				<img src="<?php echo base_url();?>/public/themes/landing/img/forklift.png" class="img-responsive img-hero" alt="KingAdmin">
			</div>
		</div>
	</section>
	<!-- END HERO SECTION -->
		...
		<div class="container">
			...
			<div class="container">
				<div class="row feature-item">
					...
					<div class="col-sm-5">
						<div class="img-box">
							<img src="<?php echo base_url();?>/public/themes/landing/img/cargo.jpg" class="img-responsive" alt="Feature">
						</div>
					</div>
				</div>
			</div>
