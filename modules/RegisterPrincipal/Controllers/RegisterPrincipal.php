<?php
namespace Modules\RegisterPrincipal\Controllers;

class RegisterPrincipal extends \CodeIgniter\Controller
{
	private $client;
	...
	public function index()
	{
		...
		$data['page_title'] = "Register Principal";
		$data['page_subtitle'] = "Register Principal Page";
		return view('Modules\RegisterPrincipal\Views\index',$data);
	}
}