<?php
namespace Modules\KodePerkiraan\Controllers;

class KodePerkiraan extends \CodeIgniter\Controller
{
	private $client;
	...
	public function index()
	{
		...
		$data['page_title'] = "Kode Perkiraan";
		$data['page_subtitle'] = "Kode Perkiraan Page";
		return view('Modules\KodePerkiraan\Views\index',$data);
	}
}