...
class Inventorynonavi extends \CodeIgniter\Controller
{
	...
	public function index()
	{
		...
		return view('Modules\Inventorynonavi\Views\index', $data);
	}
	...
	public function getAllData($prcode, $clength, $ctcode, $condition)
	{
		...
		$response = $this->client->request('GET', 'reports/rptInventoryNonAvi', [
			'headers' => [
	...
	public function reportPdf($prcode = '', $clength = '', $ctcode = '', $condition = '')
	{
		...
		<html>
			<head>
				<title>Inventory non Available Report</title>
		...
		$mpdf->setHeader('|<h3>PT. CONTINDO RAYA<br>
					INVENTORY NON AVAILABLE REPORT</h3>|PAGE {PAGENO}');
	...
	public function reportExcel($prcode = '', $clength = '', $ctcode = '', $condition = '')
	{
		...
		$exl->setActiveSheetIndex(0)
			->setCellValue('A1', 'INVENTORY NON AVAILABLE REPORT');
