<?php
namespace Modules\AccountStatementReport\Controllers;

class AccountStatementReport extends \CodeIgniter\Controller
{
	private $client;
	...
	public function index()
	{
		...
		$data['page_title'] = "Account Statement Report";
		$data['page_subtitle'] = "Account Statement Report Page";
		return view('Modules\AccountStatementReport\Views\index',$data);
	}
}