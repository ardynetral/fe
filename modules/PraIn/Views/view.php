	...
	<div class="main-content">
		...
		<div class="widget widget-table" id="OrderPra">
			<div class="widget-header">
				<h3><i class="fa fa-table"></i>Order Pra In</h3>
			</div>
			...
			<div class="widget-footer">
				<a href="<?=site_url('prain');?>" class="btn btn-default">Kembali</a>
				<a href="<?=site_url('prain/edit/'.$header[0]['praid']);?>" class="btn btn-success">Edit</a>
			</div>
		</div>	
	</div>
</div>
