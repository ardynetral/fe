<?php
namespace Modules\SummaryInvoiceReport\Controllers;

class SummaryInvoiceReport extends \CodeIgniter\Controller
{
	private $client;
	...
	public function index()
	{
		...
		$data['page_title'] = "Summary Invoice Report";
		$data['page_subtitle'] = "Summary Invoice Report Page";
		return view('Modules\SummaryInvoiceReport\Views\index',$data);
	}
}