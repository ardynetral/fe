	...
	<div class="main-content">
		...
		<div class="widget widget-table">
			...
			<div class="widget-content">
				<div class="row">
					<div class="col-md-12">
						<a href="<?=site_url('user/add');?>"class="btn btn-primary"><i class="fa fa-plus-square"></i>&nbsp;Add New</a>
					</div>
				</div><br>		
				<div class="row">
					<div class="col-md-12">
						...
						<table id="usrTable" class="table table-hover table-bordered" style="width:100%;">
							...
							<tbody>
								...
								<tr>
									...
									<td width="150">
										<a href="<?=site_url('user/view/'.$u['user_id']);?>" class="btn btn-xs btn-primary">View</a>
										<a href="<?=site_url('user/edit/'.$u['user_id']);?>" class="btn btn-xs btn-default">Edit</a>
										<?php if($u['is_block']=='y'): ?>
