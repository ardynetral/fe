<?php
namespace Modules\CashAdvance\Controllers;

class CashAdvance extends \CodeIgniter\Controller
{
	private $client;
	...
	public function index()
	{
		...
		$data['page_title'] = "Cash Advance";
		$data['page_subtitle'] = "Cash Advance Page";
		return view('Modules\CashAdvance\Views\index',$data);
	}
}