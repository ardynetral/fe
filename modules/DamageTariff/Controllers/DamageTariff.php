<?php
namespace Modules\DamageTariff\Controllers;

class DamageTariff extends \CodeIgniter\Controller
{
	private $client;
	...
	public function index()
	{
		...
		$data['data'] = "";
		$data['page_title'] = "Damage Tariff";
		$data['page_subtitle'] = "Damage Tariff page";
		return view('Modules\DamageTariff\Views\index',$data);
	}
}