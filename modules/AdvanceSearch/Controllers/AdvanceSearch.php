<?php
namespace Modules\AdvanceSearch\Controllers;

class AdvanceSearch extends \CodeIgniter\Controller
{
	private $client;
	...
	public function index()
	{
		...
		$data['page_subtitle'] = "Advance Search";
		return view('Modules\AdvanceSearch\Views\index',$data);
	}
}