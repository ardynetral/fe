<?php
namespace Modules\Consignee\Controllers;

class Consignee extends \CodeIgniter\Controller
{
	private $client;
	...
	public function index()
	{
		...
		$data['page_subtitle'] = "Consignee Page";
		return view('Modules\Consignee\Views\index',$data);
	}
	...
	public function view($code)
	{
		...
		return view('Modules\Consignee\Views\view',$data);
	}	
	...
	public function add()
	{
		...
		$data['page_title'] = "Consignee";
		$data['page_subtitle'] = "Add Consignee Page";				
		$data['country_dropdown'] = country_dropdown($selected='');
		return view('Modules\Consignee\Views\add',$data);		
	}	
	...
	public function edit($code)
	{
		...
		return view('Modules\Consignee\Views\edit',$data);		
	}	
