...
<div class="content">
	<div class="main-header">
		<h2>Debitur</h2>
		<em>Edit Debitur page</em>
	</div>
	<div class="main-content">

		<div class="widget">
			<div class="widget-header">
				<h3><i class="fa fa-edit"></i> Edit Debitur</h3>
			</div>
					...
					<fieldset>
						<div class="row">
							<div class="col-md-6">
								...
								<div class="form-group">
									<label for="cutype" class="col-sm-3 control-label text-right">Type</label>
									<div class="col-sm-9">
										<input type="text" name="cutype" class="form-control" id="cutype" value="<?=@$data['cutype']?>">
									</div>
								</div>
								<div class="form-group">
