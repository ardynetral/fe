<?php
namespace Modules\CfsActivityReport\Controllers;

class CfsActivityReport extends \CodeIgniter\Controller
{
	private $client;
	...
	public function index()
	{
		...
		$data['page_title'] = "CFS Activity Report";
		$data['page_subtitle'] = "CFS Activity Report Page";
		return view('Modules\CfsActivityReport\Views\index',$data);
	}
}