...
class Dailyrepairactivity extends \CodeIgniter\Controller
{
	...
	public function index()
	{
		...
		$data = [];
		return view('Modules\Dailyrepairactivity\Views\add',$data);		
	}
	...
	public function view($code)
	{
		...
		return view('Modules\Dailyrepairactivity\Views\view',$data);
	}	
	...
	public function edit($code)
	{
		...
		return view('Modules\Dailyrepairactivity\Views\edit',$data);		
	}	
