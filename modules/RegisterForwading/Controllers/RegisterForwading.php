<?php
namespace Modules\RegisterForwading\Controllers;

class RegisterForwading extends \CodeIgniter\Controller
{
	private $client;
	...
	public function index()
	{
		...
		$data['data'] = "";
		$data['page_title'] = "Register Forwading/EMKL";
		$data['page_subtitle'] = "Register Forwading/EMKL Page";
		return view('Modules\RegisterForwading\Views\index',$data);
	}
}