<?php
namespace Modules\CfsStuffing\Controllers;

class CfsStuffing extends \CodeIgniter\Controller
{
	private $client;
	...
	public function index()
	{
		...
		$data['page_title'] = "CFS Stuffing";
		$data['page_subtitle'] = "CFS Stuffing Page";
		return view('Modules\CfsStuffing\Views\index',$data);
	}
}