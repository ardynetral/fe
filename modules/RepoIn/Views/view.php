							...
							<div class="row">
								<div class="col-sm-6">
									<div class="form-group">
										...
										<div class="col-sm-4">
											<input type="text" name="cpopr" id="cpopr" class="form-control" value="<?=$cpopr;?>" readonly>
										</div>
									</div>
									<div class="form-group">
										<label for="cpopr " class="col-sm-5 control-label text-right">Customer</label>
										<div class="col-sm-4">
											<input type="text" name="cpcust" id="cpcust" class="form-control" value="<?=$cpcust;?>"readonly>
										</div>
									</div>												
									<div class="form-group">
