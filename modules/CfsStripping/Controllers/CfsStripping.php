<?php
namespace Modules\CfsStripping\Controllers;

class CfsStripping extends \CodeIgniter\Controller
{
	private $client;
	...
	public function index()
	{
		...
		$data['page_title'] = "CFS Stripping";
		$data['page_subtitle'] = "CFS Stripping Page";
		return view('Modules\CfsStripping\Views\index',$data);
	}
}