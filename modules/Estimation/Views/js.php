...
$(document).ready(function() {
	...
	$("#ctTable tbody").on("click", ".print", function(e) {
		...
		window.open("<?=site_url('estimation/print/'); ?>" + crno + "/" + type, '_blank', 'height=600,width=900,toolbar=no,directories=no,status=no, menubar=no,scrollbars=no,resizable=no ,modal=yes');
	});
