						...
						<table class="tbl-form" width="100%">
							...
							<tbody>
								...
								<tr>
									...
									<td><input <?php echo $readonly; ?> type="text" name="cpoorderno" id="cpoorderno" class="form-control" value="<?= ''; ?>"></td>
									<td class="text-right">EIR Out</td>
									<td colspan="3"><input <?php echo $readonly; ?> type="text" name="cpoeir" id="cpoeir" class="form-control" value="<?= ''; ?>"></td>
								</tr>
								<!-- baris 2  -->
								<tr>
									<td class="text-right" width="130">Principal</td>
									<td><input <?php echo $readonly; ?> type="text" name="cpopr1" id="cpopr1" class="form-control" value="<?= ''; ?>"></td>
									...
									<td colspan="3"><input <?php echo $readonly; ?> type="text" name="cporefout" id="cporefout" class="form-control" value="<?= ''; ?>"></td>
								</tr>
								<!-- baris 3  -->
								<tr>
									<td class="text-right" width="130">Customer</td>
									<td><input <?php echo $readonly; ?> type="text" name="cpcust1" id="cpcust1" class="form-control" value="<?= ''; ?>"></td>
								...
								<tr>
									...
									<td><input <?php echo $readonly; ?> type="text" name="ctcode" id="ctcode" class="form-control" value="<?= ''; ?>"></td>
								...
								<tr>
									...
									<td><input <?php echo $readonly; ?> type="text" name="crweightl" class="form-control" id="crweightl" value="<?= ''; ?>"></td>
									<td class="text-right">Receipt No :</td>
									<td colspan="3"><input <?php echo $readonly; ?> type="text" name="cporeceptno" id="cporeceptno" class="form-control" value="<?= ''; ?>"></td>
								</tr>
								<!-- baris 7  -->
								<tr>
								...
								<tr>
									...
									<td><input <?php echo $readonly; ?> type="text" name="crnetk" id="crnetk" class="form-control" value="<?= ''; ?>"></td>
									<td class="text-right">Netto (Lbs) :</td>
									<td><input <?php echo $readonly; ?> type="text" name="crnetl" class="form-control" id="crnetl" value="<?= ''; ?>"></td>
									<td class="text-right">Destination Port :</td>
									<td colspan="3"><input <?php echo $readonly; ?> type="text" name="cpoload" id="cpoload" class="form-control" value="<?= ''; ?>"></td>
								</tr>
								<!-- baris 9  -->
								<tr>
									<td class="text-right" width="130">Volume (CBM) :</td>
									<td><input <?php echo $readonly; ?> type="text" name="crvol" id="crvol" class="form-control" value="<?= ''; ?>"></td>
									<td class="text-right">Material :</td>
									<td><input <?php echo $readonly; ?> type="text" name="mtdesc" class="form-control" id="mtdesc" value="<?= ''; ?>"></td>
									<td class="text-right">Cargo :</td>
									<td colspan="3"><input <?php echo $readonly; ?> type="text" name="cpocargo" id="cpocargo" class="form-control" value="<?= ''; ?>"></td>
								</tr>
								<!-- baris 10 -->
								<tr>
									<td class="text-right" width="130">Manfacture :</td>
									<td><input <?php echo $readonly; ?> type="text" name="crmanuf" id="crmanuf" class="form-control" value="<?= ''; ?>"></td>
								...
								<tr>
									...
									<td><input <?php echo $readonly; ?> type="text" name="crlastact" id="crlastact" class="form-control" value="<?= ''; ?>"></td>
									<td class="text-right">Receiver :</td>
									<td colspan="3"><input <?php echo $readonly; ?> type="text" name="cporeceiv" id="cporeceiv" class="form-control" value="<?= ''; ?>"></td>
								</tr>
