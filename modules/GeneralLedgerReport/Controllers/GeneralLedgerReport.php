<?php
namespace Modules\GeneralLedgerReport\Controllers;

class GeneralLedgerReport extends \CodeIgniter\Controller
{
	private $client;
	...
	public function index()
	{
		...
		$data['page_subtitle'] = "General Ledger Report Page";
		return view('Modules\GeneralLedgerReport\Views\index',$data);
	}
}