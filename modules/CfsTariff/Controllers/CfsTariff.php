<?php
namespace Modules\CfsTariff\Controllers;

class CfsTariff extends \CodeIgniter\Controller
{
	private $client;
	...
	public function index()
	{
		...
		$data['data'] = "";
		$data['page_title'] = "Cfs Tariff";
		$data['page_subtitle'] = "Cfs Tariff page";
		return view('Modules\CfsTariff\Views\index',$data);
	}
}