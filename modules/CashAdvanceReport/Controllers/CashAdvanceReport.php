<?php
namespace Modules\CashAdvanceReport\Controllers;

class CashAdvanceReport extends \CodeIgniter\Controller
{
	private $client;
	...
	public function index()
	{
		...
		$data['page_title'] = "Cash Advance Report";
		$data['page_subtitle'] = "Cash Advance Report Page";
		return view('Modules\CashAdvanceReport\Views\index',$data);
	}
}