<div class="modal fade in" id="repoTariffDetailModal" tabindex="-1" role="dialog" aria-labelledby="repoTariffDetailModalLabel" aria-hidden="true">
	<div class="modal-dialog">
		<div class="modal-content">
			<div class="modal-header">
				<button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
				<h4 class="modal-title" id="myModalLabel">Add Repo Tariff Detail</h4>
			</div>
			<form id="tariffDetail" class="form-horizontal" role="form" method="post">
					...
					<div class="form-group">
						...
						<div class="col-sm-9">
							<label class="control-inline fancy-radio custom-bgcolor-green">
								<input type="radio" name="rtef" id="rtef" value="1">
								<span><i></i>Full</span>
							</label>
							<label class="control-inline fancy-radio custom-bgcolor-green">
								<input type="radio" name="rtef" id="rtef" value="0" checked>
								<span><i></i>Empty</span>
							</label>								
						</div>
					</div>					
