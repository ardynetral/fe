<?php
namespace Modules\BillRepair\Controllers;

class BillRepair extends \CodeIgniter\Controller
{
	private $client;
	...
	public function index()
	{
		...
		$data['page_title'] = "Bill Repair";
		$data['page_subtitle'] = "Bill Repair Page";
		return view('Modules\BillRepair\Views\index',$data);
	}
}