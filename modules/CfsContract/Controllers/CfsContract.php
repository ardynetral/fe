<?php
namespace Modules\CfsContract\Controllers;

class CfsContract extends \CodeIgniter\Controller
{
	private $client;
	...
	public function index()
	{
		...
		$data['data'] = "";
		$data['page_title'] = "Cfs Contract";
		$data['page_subtitle'] = "Cfs Contract page";
		return view('Modules\CfsContract\Views\index',$data);
	}
}