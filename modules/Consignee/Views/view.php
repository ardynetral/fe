	...
	<div class="main-content">
		...
		<div class="widget widget-table">
			<div class="widget-header">
				<h3><i class="fa fa-table"></i> <?=$page_title?> Detail</h3></div>
			<div class="widget-content">	
				...
				<div class="row">
					<div class="col-md-12">
						<a href="<?=site_url('consignee');?>" class="btn btn-default">Back</a>
						<a href="<?=site_url('consignee/edit/'.$data['cucode']);?>" class="btn btn-success">Edit</a>
					</div>
				</div>
			</div>		
		</div>		
