<?php
namespace Modules\DailyCashReport\Controllers;

class DailyCashReport extends \CodeIgniter\Controller
{
	private $client;
	...
	public function index()
	{
		...
		$data['page_title'] = "Daily Cash Report";
		$data['page_subtitle'] = "Daily Cash Report Page";
		return view('Modules\DailyCashReport\Views\index',$data);
	}
}