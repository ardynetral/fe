			...
			<div class="widget-content">
				...
				<!-- 								<option value="11">DEPOT to DEPOT (OUT)</option>
									...
									<div class="form-group">
										...
										<div class="col-sm-7">
											<input type="text" name="redline" id="redline" class="form-control" value="<?=@$recity;?>" readonly>
										</div>
									</div>
									<div class="form-group">
									...
									<div class="form-group" style="display: none;">
										...
										<div class="col-sm-7">
											<label class="control-inline fancy-checkbox custom-color-green">
												<input type="checkbox" name="liftoffcharge" id="liftoffcharge" value="1" checked disabled>
												<span></span>
											</label>
										</div>
									</div>					
									<div class="form-group">
										...
										<div class="col-sm-7">
											<input type="text" class="form-control" id="repovoyid" name="repovoyid" value="<?=$data['recpives']?>" readonly>
										</div>
									</div>		
									<div class="form-group">
