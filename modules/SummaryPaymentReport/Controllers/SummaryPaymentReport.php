<?php
namespace Modules\SummaryPaymentReport\Controllers;

class SummaryPaymentReport extends \CodeIgniter\Controller
{
	private $client;
	...
	public function index()
	{
		...
		$data['page_title'] = "Summary Payment Report";
		$data['page_subtitle'] = "Summary Payment Report Page";
		return view('Modules\SummaryPaymentReport\Views\index',$data);
	}
}