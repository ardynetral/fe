<?php
namespace Modules\Shipper\Controllers;

class Shipper extends \CodeIgniter\Controller
{
	private $client;
	...
	public function index()
	{
		...
		$data['page_title'] = "Shipper";
		$data['page_subtitle'] = "Shipper Page";
		return view('Modules\Shipper\Views\index',$data);
	}
	...
	public function view($code)
	{
		...
		return view('Modules\Shipper\Views\view',$data);
	}	
	...
	public function add()
	{
		...
		$data['page_title'] = "Shipper";
		$data['page_subtitle'] = "Add Shipper Page";				
		$data['country_dropdown'] = country_dropdown($selected='');
		return view('Modules\Shipper\Views\add',$data);		
	}	
	...
	public function edit($code)
	{
		...
		return view('Modules\Shipper\Views\edit',$data);		
	}	
