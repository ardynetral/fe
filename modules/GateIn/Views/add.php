						...
						<table class="tbl-form" width="100%">
							...
							<tbody>
								<tr>
									...
									<td><input <?php echo $readonly; ?> type="text" name="cpiorderno" id="cpiorderno" class="form-control" value="<?= ''; ?>"></td>
									<td class="text-right">EIR In</td>
									<td colspan="3"><input <?php echo $readonly; ?> type="text" name="cpieir" id="cpieir" class="form-control" value="<?= ''; ?>"></td>
								</tr>
								...
								<tr>
									...
									<td><input <?php echo $readonly; ?> type="text" name="cpopr" id="cpopr" class="form-control" value="<?= ''; ?>"></td>
									<td class="text-right">Ref In No # :</td>
									<td colspan="3"><input <?php echo $readonly; ?> type="text" name="cpirefin" id="cpirefin" class="form-control" value="<?= ''; ?>"></td>
								</tr>
								...
								<tr>
									...
									<td><input <?php echo $readonly; ?> type="text" name="cpcust" id="cpcust" class="form-control" value="<?= ''; ?>"></td>
									<td class="text-right">Receipt No</td>
									<td colspan="3"><input <?php echo $readonly; ?> type="text" name="cpireceptno" id="cpireceptno" class="form-control" value="<?= ''; ?>"></td>
								...
								<tr>
									...
									<td><input <?php echo $readonly; ?> type="text" name="cpipratgl" id="cpipratgl" class="form-control" value="<?= ''; ?>"></td>
								...
								<tr>
									...
									<td><input <?php echo $readonly; ?> type="text" name="ctcode" class="form-control" id="ctcode" value="<?= ''; ?>"></td>
									<td class="text-right">Time In</td>
									<td><input <?php echo $readonly; ?> type="text" name="cpijam" id="cpijam" class="form-control" value="<?= ''; ?>"></td>
								...
								<tr>
									...
									<td><input <?php echo $readonly; ?> type="text" name="vesid" class="form-control" id="vesid" value="<?= ''; ?>"></td>
									<td class="text-right">Voyage :</td>
									<td><input type="text" name="voyno" id="voyno" class="form-control" value="<?= ''; ?>" readonly>
										<input type="hidden" name="cpivoy" id="cpivoy" class="form-control" value="<?= ''; ?>">
									</td>
									<td class="text-right">Vessel Operator :</td>
									<td colspan="3"><input <?php echo $readonly; ?> type="text" name="vesopr" id="vesopr" class="form-control" value="<?= ''; ?>"></td>
								</tr>


								<tr>
									<td class="text-right" width="130">Origin Port :</td>
									<td><input <?php echo $readonly; ?> type="text" name="poport" class="form-control" id="poport" value="<?= ''; ?>"></td>
									<td class="text-right">Redeliverer :</td>
									<td><input <?php echo $readonly; ?> type="text" name="cpideliver" class="form-control" id="cpideliver" value="<?= ''; ?>"></td>
									<td class="text-right">Discharge Date :</td>
									<td colspan="3"><input <?php echo $readonly; ?> type="text" name="cpidisdat" id="cpidisdat" class="form-control" value="<?= ''; ?>"></td>
								</tr>
								<tr>
