<?php
namespace Modules\AccountReceivableStatement\Controllers;

class AccountReceivableStatement extends \CodeIgniter\Controller
{
	private $client;
	...
	public function index()
	{
		...
		$data['page_title'] = "Account Receivable Statement";
		$data['page_subtitle'] = "Account Receivable Statement Page";
		return view('Modules\AccountReceivableStatement\Views\index',$data);
	}
}