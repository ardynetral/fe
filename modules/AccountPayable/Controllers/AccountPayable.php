<?php
namespace Modules\AccountPayable\Controllers;

class AccountPayable extends \CodeIgniter\Controller
{
	private $client;
	...
	public function index()
	{
		...
		$data['page_subtitle'] = "Account Payable Page";
		return view('Modules\AccountPayable\Views\index',$data);
	}
}