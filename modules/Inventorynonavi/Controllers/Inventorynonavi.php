...
namespace Modules\Inventorynonavi\Controllers;

use PhpOffice\PhpSpreadsheet\Spreadsheet;
use PhpOffice\PhpSpreadsheet\Writer\Xlsx;
use PhpOffice\PhpSpreadsheet\Style\Border;

class Inventorynonavi extends \CodeIgniter\Controller
{
	private $client;
	...
	public function index()
	{
		...
		return view('Modules\Inventorynonavi\Views\add', $data);
	}
	...
	public function view($code)
	{
		...
		$data['group_id'] = $group_id;
		return view('Modules\Inventorynonavi\Views\view', $data);
	}
	...
	public function reportPdf()
	{
		...
		<html>
			<head>
				<title>Inventory Non Avi Report</title>
		...
		$html .= '
			<h4>RInventory Non Avi Report</h4>
	...
	public function reportExcel()
	{
		...
		$exl->setActiveSheetIndex(0)
			->setCellValue('A1', 'Inventory Non Avi Report');
		...
		$writer = new Xlsx($exl);
		$filename = 'InventoryNonAvi-' . date('Y-m-d-His');
