<?php
namespace Modules\BillClean\Controllers;

class BillClean extends \CodeIgniter\Controller
{
	private $client;
	...
	public function index()
	{
		...
		$data['page_title'] = "Bill Clean";
		$data['page_subtitle'] = "Bill Clean Page";
		return view('Modules\BillClean\Views\index',$data);
	}
}