	...
	<div class="main-content">
		...
		<div class="widget">
			<div class="widget-header">
				<h3><i class="fa fa-edit"></i> Add Debitur</h3>
			</div>
			<div class="widget-content">
				...
				<form id="#formCType" class="form-horizontal" role="form">
					...
					<fieldset>
						...
						<div class="form-group">
							<label for="cutype" class="col-sm-2 control-label text-right">Type</label>
							<div class="col-sm-3">
								<input type="text" name="cutype" class="form-control" id="cutype">
							</div>
						</div>
						<div class="form-group">
