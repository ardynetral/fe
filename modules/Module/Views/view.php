	...
	<div class="main-content">
		...
		<div class="widget widget-table">
			<div class="widget-header">
				<h3><i class="fa fa-table"></i> Country Detail</h3></div>
			<div class="widget-content">	
				<div class="row">
					<div class="col-md-12">
						...
						<table class="table">
							<tbody>
								<tr><th width="100">Country CODE</th><td width="2">:</td><td><?=$data['cncode'];?></td></tr>
								<tr><th width="100">Description</th><td width="2">:</td><td><?=$data['cndesc'];?></td></tr>
							</tbody>
						</table>
						<?php else: ?>
