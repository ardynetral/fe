				...
				<form id="form_input" class="form-horizontal" role="form">
					...
					<tbody>
						<tr>
							...
							<td><input <?php echo $readonly;?> type="text" name="CRNO" class="form-control" id="CRNO" value="<?=@$crno;?>"></td>
							<td ></td>
							<td ></td>
						...
						<tr>
							...
							<td><input <?php echo $readonly;?> type="text" name="CRWEIGHTK" id="CRWEIGHTK" class="form-control" value="<?=@$details['datas']['crweightk'];?>"></td>
							<td class="text-right">Weight (Lbs) :</td>
							<td ><input <?php echo $readonly;?> type="text" name="CRWEIGHTL" id="CRWEIGHTL" class="form-control" value="<?=@$details['datas']['crweightl'];?>"></td>
						...
						<tr>
							...
							<td><input <?php echo $readonly;?> type="text" name="CRTARAK" id="CRTARAK" class="form-control" value="<?=@$details['datas']['crtarak'];?>"></td>
							<td class="text-right">Tare (Lbs) :</td>
							<td ><input <?php echo $readonly;?> type="text" name="CRTARAL" id="CRTARAL" class="form-control" value="<?=@$details['datas']['crtaral'];?>"></td>
						...
						<tr>
							...
							<td><input <?php echo $readonly;?> type="text" name="CRNETK" id="CRNETK" class="form-control" value="<?=@$details['datas']['crnetk'];?>"></td>
							<td class="text-right">Netto (Lbs) :</td>
							<td ><input <?php echo $readonly;?> type="text" name="CRNETL" id="CRNETL" class="form-control" value="<?=@$details['datas']['crnetl'];?>"></td>
							<td class="text-right"></td>
							<td ></td>
						</tr>	
						<tr>
							<td class="text-right" width="130">Volume (Cbm) :</td>
							<td><input <?php echo $readonly;?> type="text" name="CRVOL" id="CRVOL" class="form-control" value="<?=@$details['datas']['crvol'];?>"></td>
							<td class="text-right">Material :</td>
							<td ><input <?php echo $readonly;?> type="text" name="MTCODE1" id="MTCODE1" class="form-control" value="<?=@$details['datas']['mtcode1'];?>"></td>
						...
						<tr>
							...
							<td><input <?php echo $readonly;?> type="text" name="CRMANUF" id="CRMANUF" class="form-control" value="<?=@$details['datas']['crmanuf'];?>"></td>
							<td class="text-right">Manufacture Date :</td>
							<td ><input <?php echo $readonly;?> type="text" name="MANUFDATE" id="MANUFDATE" class="form-control" value="<?=@$details['datas']['manufdate'];?>"></td>
						...
						<tr>
							...
							<td><input <?php echo $readonly;?> type="text" name="SVSURDAT" class="form-control" id="SVSURDAT" value="<?=@$details['datas']['svsurdat'];?>"></td>
							<td ></td>
							<td ></td>
						...
						<tr>
							...
							<td><input <?php echo $readonly;?> type="text" name="SVCOND" class="form-control" id="SVCOND" value="<?=@$details['datas']['svcond'];?>"></td>
							<td ></td>
							<td ></td>
							<td class="text-right"></td>
							<td ></td>
						...
						<tr>
							...
							<td><input <?php echo $readonly;?> type="text" name="SYID" class="form-control" id="" value="<?= $uname;?>"></td>
							<td ></td>
							<td ></td>
