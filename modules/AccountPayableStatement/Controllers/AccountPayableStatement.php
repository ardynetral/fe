<?php
namespace Modules\AccountPayableStatement\Controllers;

class AccountPayableStatement extends \CodeIgniter\Controller
{
	private $client;
	...
	public function index()
	{
		...
		$data['page_title'] = "Account Payable Statement";
		$data['page_subtitle'] = "Account Payable Statement Page";
		return view('Modules\AccountPayableStatement\Views\index',$data);
	}
}