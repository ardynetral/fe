...
$routes->add('/gatein/print/(:alphanum)', '\Modules\GateIn\Controllers\GateIn::print/$1', ['filter' => 'login']);
$routes->add('/gatein/print_eir_in/(:alphanum)', '\Modules\GateIn\Controllers\GateIn::print_eir_in/$1', ['filter' => 'login']);
