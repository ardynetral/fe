<?php
namespace Modules\GeneralVoucher\Controllers;

class GeneralVoucher extends \CodeIgniter\Controller
{
	private $client;
	...
	public function index()
	{
		...
		$data['page_title'] = "General Voucher";
		$data['page_subtitle'] = "General Voucher Page";
		return view('Modules\GeneralVoucher\Views\index',$data);
	}
}